...
class BaseAgent:
    ...
    def reset(self, init_qpos: torch.Tensor = None):
        ...
        # self.robot.set_pose(Pose(raw_pose=torch.tensor([[-6.1500e-01,  7.2760e-11, -1.4901e-08,  1.0000e+00,  0.0000e+00,
        #   0.0000e+00,  0.0000e+00]])))
        # self.robot.set_root_angular_velocity(torch.tensor([[0., 0., 0.]]))
        # self.robot.set_root_linear_velocity(torch.tensor([[0., 0., 0.]]))
