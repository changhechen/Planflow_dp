...
class BaseEnv(gym.Env):
    ...
    def get_obs(self, info: Optional[Dict] = None):
        ...
        if self._obs_mode == "none":
            ...
            # temp_save = copy.deepcopy(obs['sensor_data'])
            obs = sensor_data_to_pointcloud(obs, self._sensors)
            # obs['sensor_data'] = temp_save
    ...
    def reset_agent(self):
        ...
        if self.agent is not None:
            self.agent.reset(init_qpos=torch.tensor([[ 2.2171e-05,  3.8691e-01, -2.2321e-02, -1.9638e+00, -7.5672e-03,
          2.3466e+00,  7.5505e-01,  4.0000e-02,  4.0000e-02]]))
