...
def _load_ycb_dataset():
    global YCB_DATASET
    YCB_DATASET = {
        "model_data": load_json("/home/kalman/Han/06_07_2025_skill_composition_more_task_debug/ManiSkill_multiview/mani_skill/assets/mani_skill2_ycb/info_pick_v0.json"),
    }
