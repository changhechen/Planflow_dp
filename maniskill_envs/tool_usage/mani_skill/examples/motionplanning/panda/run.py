...
from mani_skill.examples.motionplanning.panda.solutions import solvePushCube, solvePickCube, solveStackCube, solvePegInsertionSide, solvePlugCharger, solvePullCubeTool, solveLiftPegUpright, solvePullCube, solvePlaceSphereMy, solveTwoStep_my_together, solveTwoStep_my_inbin, solveTwoStep_my_outbin, solveTableSort_my, solveTableSortObj0_my, solveTableSortObj1_my, solveTableSortObj2_my, solveTableSortExp1Type1, solveTableSortExp1Type2, solveTableSortExp1Type3, solveTableSortExp1Type4, solveTableSortExp1Type5, solveTableSortExp1Type6
# python -m mani_skill.examples.motionplanning.panda.run -e "TwoStep_my_together" --save-video -o "pointcloud"
...
MP_SOLUTIONS = {
    ...
    "PlaceSphere_my": solvePlaceSphereMy,
    "TwoStep_my_together": solveTwoStep_my_together,
    "TwoStep_my_inbin": solveTwoStep_my_inbin,
    "TwoStep_my_outbin": solveTwoStep_my_outbin,   
    "TableSortMy": solveTableSort_my,
    "TableSortMyOneactionObj0": solveTableSortObj0_my,
    "TableSortMyOneactionObj1": solveTableSortObj1_my,
    "TableSortMyOneactionObj2": solveTableSortObj2_my,
    "TableSortOneactionExp1Type1": solveTableSortExp1Type1,
    "TableSortOneactionExp1Type2": solveTableSortExp1Type2,
    "TableSortOneactionExp1Type3": solveTableSortExp1Type3,
    "TableSortOneactionExp1Type4": solveTableSortExp1Type4,
    "TableSortOneactionExp1Type5": solveTableSortExp1Type5,
    "TableSortOneactionExp1Type6": solveTableSortExp1Type6,
