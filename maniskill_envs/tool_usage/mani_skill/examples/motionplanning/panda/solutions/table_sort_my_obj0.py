...
from mani_skill.envs.tasks.tabletop.table_sort_my_oneaction_obj0 import TableSortMyOneactionObj0Env
from mani_skill.examples.motionplanning.panda.motionplanner import \
    PandaArmMotionPlanningSolver
from mani_skill.examples.motionplanning.panda.utils import (
    compute_grasp_info_by_obb, get_actor_obb)

def solve(env: TableSortMyOneactionObj0Env, seed=None, debug=False, vis=False):
    env.reset(seed=seed)
    env.reset_agent()
