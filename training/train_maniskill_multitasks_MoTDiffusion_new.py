...
from model.language_projector import LanguageProjector
        ...
        for epoch_idx in tglobal:
            ...
            with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
                for batch_idx, nbatch in enumerate(tepoch):
                    ...
                    nhidden_state = nbatch['hidden_state'].to(device)
                    nhidden_state_mask = nbatch['hidden_state_mask'].to(device)
                    ...
                    # encoder language features and project to low-dim
                    lang_features, masks, valid_step = nets['lang_projector'](nhidden_state, nhidden_state_mask) # lang_features: (B, T, N*proj_dim)
                    ...
                    if checkpoint_config['save_freq'] > 0 and global_step % checkpoint_config['save_freq'] == 0:
                        ...
                        ema_nets = nn.ModuleDict({
                            ...
                            'lang_projector': nets['lang_projector'],
